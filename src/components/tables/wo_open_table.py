...
class OpenWorkOrdersTableWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.filter_input.setPlaceholderText("Filtrar por Numero de Orden...")
    ...
    def load_work_orders(self):
        ...
        for row, work_order in enumerate(work_orders):
            ...
            end_date_item = QTableWidgetItem(work_order["end_date"])
            ...
            if end_date < today:
                end_date_item.setBackground(QColor("red"))
            elif end_date == today:
    ...
    def filter_table(self):
        ...
        all_work_orders = self.work_order_service.get_open_workorders_filter_service()
        ...
        filtered_work_orders = [
            ...
            if filter_text in str(work_order["work_order_id"]).lower()
        ]
